...
namespace Google.Cloud.Spanner.EntityFrameworkCore.Storage
{
    class SpannerRelationalDatabase : RelationalDatabase
    {
        public SpannerRelationalDatabase(DatabaseDependencies dependencies,
