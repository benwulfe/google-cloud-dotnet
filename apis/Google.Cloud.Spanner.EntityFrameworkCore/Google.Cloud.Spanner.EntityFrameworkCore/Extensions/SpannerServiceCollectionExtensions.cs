...
using Google.Cloud.Spanner.EntityFrameworkCore.Infrastructure.Internal;
using Google.Cloud.Spanner.EntityFrameworkCore.Query.ExpressionTranslators.Internal;
using Google.Cloud.Spanner.EntityFrameworkCore.Query.Internal;
using Google.Cloud.Spanner.EntityFrameworkCore.Query.Sql.Internal;
using Google.Cloud.Spanner.EntityFrameworkCore.Storage;
using Google.Cloud.Spanner.EntityFrameworkCore.Storage.Internal;
using Google.Cloud.Spanner.EntityFrameworkCore.Update.Internal;
    ...
    public static class SpannerServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddEntityFrameworkSpanner(this IServiceCollection serviceCollection)
        {
            ...
            var builder = new EntityFrameworkRelationalServicesBuilder(serviceCollection)
                .TryAdd<IDatabase, SpannerRelationalDatabase>()
