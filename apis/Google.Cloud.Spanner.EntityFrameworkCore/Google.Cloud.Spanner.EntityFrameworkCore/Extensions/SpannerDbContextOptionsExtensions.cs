...
using Google.Cloud.Spanner.EntityFrameworkCore.Infrastructure;
...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class SpannerDbContextOptionsExtensions
    {
            ...
            Action<SpannerDbContextOptionsBuilder> spannerOptionsAction = null)
        {
            ...
            var extension = (SpannerOptionsExtension)GetOrCreateExtension(optionsBuilder).WithConnectionString(connectionString);
